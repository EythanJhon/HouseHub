...
<div class="review">
      <h1> Boardong House Around Pampanga</h1>
      <div class="container">
        <div class="box">
        ...
        <div class="box">
            <img src="image/hau2.jpg">
            <h3> HOLY ANGEL UNIVERSITY </h3>
            <p> </p>
             <a href="clifton.php" class="btn">View Reviews</a>
        </div>
    </div> 
</div>
<div class="review">
      <h1> Recently Reviewed BoardingHouse</h1>                 
</div>
</section>
</div>
</div>
      ...
      <iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/3e69qM1syhcKdlpyhYIb4q?utm_source=generator"
         width="100%" height="1000" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>
      </div>
      <div class="review">
