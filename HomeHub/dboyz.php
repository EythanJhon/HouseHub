...
<body>
  <div class="nav">
    <nav>
      ...
      <a href="#" class="search-button" onclick="openMap()">Location</a> 
    </nav>
  </div>
  <div id="mapModal" class="modal">
    <div class="modal-content">
      ...
      <h2>Here's a Map</h2>
      <iframe src="https://www.google.com/maps/embed?pb=!4v1702110552623!6m8!1m7!1sWLk8-gSn41MpDEI6d8khig!2m2!1d15.21767587866271!2d120.6870908755983!3f197.14!4f-26.560000000000002!5f0.7820865974627469" 
    width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
  </div>
  <div class="hero5">
    <h3> Dboy'z Boarding House</h3>
    <div class="container"></div>
  </div>
  <br>
  <h1>Submit a Review</h1>
  <button class="black-button" onclick="toggleForm()">WRITE A REVIEW</button>
  <form id="reviewForm" action="displaydboyz_reviewed.php" method="post" enctype="multipart/form-data">
    <label>Name:</label>
